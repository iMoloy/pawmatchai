...
export default function AboutPage() {
 return (
 <div className="flex flex-col min-h-screen bg-linear-to-br from-teal-50 to-slate-100 relative overflow-hidden">
 {/* Decorative Blobs */}
 <div className="absolute top-0 right-0 w-96 h-96 bg-teal-100 rounded-full blur-3xl opacity-50 pointer-events-none -translate-y-12 translate-x-1/3"></div>
 <div className="absolute bottom-0 left-0 w-96 h-96 bg-coral-100 rounded-full blur-3xl opacity-30 pointer-events-none translate-y-1/3 -translate-x-1/3"></div>
 ...
 <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-teal-50 rounded-full text-sm font-semibold text-teal-700 mb-6 border border-teal-100 shadow-sm">
 🐾 Our Mission
 </div>
 <h1 className="text-5xl font-black mb-6 leading-tight text-slate-900">
 Find the right pet,<br />
 <span className="text-teal-600">the smart way.</span>
 </h1>
 ...
 <div>
 <h2 className="text-fluid-heading mb-6 text-slate-800 mb-6">Why we built this</h2>
 ...
 {/* Values */}
 <section className="py-10 px-4 bg-white/40 backdrop-blur-md border-y border-white/50">
 <div className="max-w-6xl mx-auto">
 <div className="text-center mb-8">
 <h2 className="text-fluid-heading mb-6 text-slate-800 mb-3">What we stand for</h2>
 <p className="text-fluid-subheading text-slate-500 max-w-xl mx-auto">Four principles guide every feature we build and every partnership we make.</p>
 </div>
 ...
 <div className="text-center mb-8">
 <h2 className="text-fluid-heading mb-6 text-slate-800 mb-3">The team behind PawMatch</h2>
 <p className="text-fluid-subheading text-slate-500 max-w-xl mx-auto">Built by a developer who loves pets, powered by AI, and fuelled by community.</p>
 </div>
 ...
 {/* CTA */}
 <section className="py-10 px-4 bg-linear-to-r from-teal-600 to-teal-700 text-white">
 <div className="max-w-3xl mx-auto text-center">
 <h2 className="text-fluid-heading mb-6">Ready to find your perfect pet?</h2>
