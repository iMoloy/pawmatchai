...
export default function ManagePetsPage() {
 ...
 console.warn(
 "Backend /api/pets/mine failed or missing, using fallback empty state for UI.",
 );
 return [];
 }
 },
 ...
 return (
 <ProtectedRoute>
 <div className="flex flex-col min-h-screen bg-linear-to-br from-teal-50 to-slate-100 relative overflow-hidden relative">
 {/* Decorative Blobs */}
 ...
 View, edit, and manage your current adoption listings.
 </p>
 </div>
 <Link
 href="/pets/add"
 ...
 <td className="px-6 py-4">
 <span
 className={`px-2.5 py-1 text-xs font-bold rounded-md border ${getStatusStyle(pet.status || "Available")}`}
 >
 ...
 <div
 key={pet.id}
 className="bg-white border border-slate-100 rounded-2xl p-4 shadow-sm flex flex-col gap-4"
 >
 <div className="flex items-center gap-4">
 <img
 src={
 ...
 <span
 className={`px-2 py-0.5 text-[10px] font-bold rounded-md border ${getStatusStyle(pet.status || "Available")}`}
 >
 {pet.status || "Available"}
 </span>
 </div>
