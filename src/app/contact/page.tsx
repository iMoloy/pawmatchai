...
export default function ContactPage() {
 ...
 <h1 className="text-5xl font-black mb-4 text-slate-900">Get in Touch</h1>
 ...
 <textarea name="message" value={form.message} onChange={handleChange} rows={6} placeholder="Tell us how we can help..." className={`${inputClass("message").replace("rounded-full", "rounded-3xl")} resize-none`} />
