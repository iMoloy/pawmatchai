...
export default function ExplorePage() {
 ...
 {/* Banner Section */}
 <div className="relative rounded-3xl overflow-hidden mb-8 bg-gradient-to-r from-teal-700 to-emerald-600 text-white p-8 md:p-12 shadow-lg">
 ...
 <h1 className="text-fluid-heading mb-6 mt-4 tracking-tight leading-tight">
