...
export default function Categories() {
 return (
 <section className="py-10 bg-linear-to-br from-teal-50 to-slate-100 relative overflow-hidden">
 <div className="absolute top-0 right-0 -translate-y-12 translate-x-1/3 w-96 h-96 bg-teal-100 rounded-full blur-3xl opacity-50 pointer-events-none"></div>
 <div className="absolute bottom-0 left-0 translate-y-1/3 -translate-x-1/3 w-96 h-96 bg-coral-100 rounded-full blur-3xl opacity-30 pointer-events-none"></div>
